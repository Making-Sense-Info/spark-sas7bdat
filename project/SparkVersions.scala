 ...
 * Spark 4 line (library 4.1.0-SNAPSHOT): Spark 4.1+ on Scala 2.13.17 — Java 17 bytecode.
 * Last Central release: 4.0.1.
 *
 * Release: this value must match the git tag without the "v" (tag v4.1.0 → "4.1.0").
 * After Central is live, bump to the next SNAPSHOT on master.
 *
